...
DROP TABLE `ovms_apitokens`;
DROP TABLE `ovms_autoprovision`;
DROP TABLE `ovms_notifies`;
DROP TABLE `ovms_carmessages`;
DROP TABLE `ovms_cars`;
DROP TABLE `ovms_historicalmessages`;
DROP TABLE `ovms_owners`;
